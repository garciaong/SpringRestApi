...
public class PrttResponse {
	...
	@JsonProperty(value = "wakalah_fee")
	...
	@JsonProperty(value = "wakalah_fee_list")
    private String wakalahFeeList;
	...
	@JsonProperty(value = "wakalah_fee_percentage")
    private String wakalahFeePercentage;
	...
	public String getWakalahFeeList() {
		return wakalahFeeList;
	}
	public void setWakalahFeeList(String wakalahFeeList) {
		this.wakalahFeeList = wakalahFeeList;
	}
	...
	public String getWakalahFeePercentage() {
		return wakalahFeePercentage;
	}
	public void setWakalahFeePercentage(String wakalahFeePercentage) {
		this.wakalahFeePercentage = wakalahFeePercentage;
	}
